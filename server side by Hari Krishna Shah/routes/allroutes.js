...
router.get("/download", async (req, res) => {
    try {
        ...
        if (response.status === 200) {
            ...
            let slide = pptx.addSlide({title:"Bar Chart Diagram Overiew"});
            let slide2 = pptx.addSlide({title:"Key Findings"});
            let slide3 = pptx.addSlide({title:"Recommendations"});
            let slide4 = pptx.addSlide({title:"Conclusions"});
            ...
            slide.addText("\nBar Chart Overview").addChart(pptx.ChartType.bar, chartData);
